...
UI_TRANSLATIONS = {
    "mr": {
        ...
        "Wrong Image Uploaded. Please upload a valid plant leaf image.": "चुकीची प्रतिमा अपलोड केली आहे. कृपया वनस्पतींच्या पानांचे वैध चित्र अपलोड करा.",
        "Unable to detect disease. Please upload a clear plant leaf image.": "रोगाचे निदान करण्यात अक्षम. कृपया वनस्पतींच्या पानांचे स्पष्ट चित्र अपलोड करा.",
    ...
    "hi": {
        ...
        "Wrong Image Uploaded. Please upload a valid plant leaf image.": "गलत छवि अपलोड की गई। कृपया पौधे की पत्ती की एक वैध छवि अपलोड करें।",
        "Unable to detect disease. Please upload a clear plant leaf image.": "रोग का पता लगाने में असमर्थ। कृपया पौधे की पत्ती की एक स्पष्ट छवि अपलोड करें।",
